// ============================================
// Comprehensive Question Data for AI Nurse Copilot Survey
// Includes all nurse (56 questions) and doctor (36 questions)
// with conditional logic and proper typing
// ============================================

import { Question, QuestionType, Condition, QuestionConfig } from '@/lib/types';

// Helper type for raw question data (without generated fields)
interface QuestionData {
  externalId: string;
  role: 'nurse' | 'doctor' | 'both';
  section: string;
  sectionOrder: number;
  order: number;
  text: string;
...
// ============================================
// NURSE QUESTIONS (56 questions, 10 sections)
// ============================================

export const nurseQuestions: QuestionData[] = [
  ...
  // Section 1: Daily Workflow and Time Split
  {
    ...
    options: [
      ...
      'Calling doctors',
      'Patient education',
      'Coordination with lab/radiology',
  ...
  },
  {
    ...
    options: [
      'Paper forms',
      'HIS/EHR system',
      'WhatsApp/phone notes then transfer',
      'Voice calls to another staff',
      'Other'
    ],
    required: true,
  },

  // Section 2: Current Tools and Friction
  {
  ...
  },
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Very poor', high: 'Excellent' }
    },
    required: true,
  },
  {
    ...
    options: [
      ...
      'Lack of devices at bedside',
      'Login issues',
      'Network issues',
      'Not nurse-friendly workflow',
      'Language issues',
      'Other'
    ],
    required: true,
  ...
  // Section 3: Communication and Instruction Loop
  {
  ...
  },
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Not useful', high: 'Extremely useful' }
    },
    required: true,
  },

  // Section 5: Errors, Risk, and Pain
  {
  ...
  },
  {
    ...
    type: 'multi-choice',
    options: [
      'Missed medication time',
      'Wrong medication dose/time',
      'Missed escalation',
      'Missing documentation for vitals',
  ...
  // Section 6: Voice Capture Feasibility
  {
  ...
  },
  {
    ...
    conditions: [
      { questionId: 'nurse_voice_comfort', operator: 'equals', value: 'Depends' }
    ],
    required: true,
  },
  {
    ...
    conditions: [
      { questionId: 'nurse_voice_comfort', operator: 'notEquals', value: 'No' }
    ],
    required: true,
  },
  {
  ...
  // Section 7: Smart Forms and Clinical Prompts
  {
  ...
  },
  {
    ...
    conditions: [
      { questionId: 'nurse_auto_followup', operator: 'in', value: ['Yes', 'Only in some cases'] }
    ],
    required: true,
  },
  {
  ...
  // Section 8: Tasks, Reminders, and Checklists
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Not at all', high: 'Extremely helpful' }
    },
    required: true,
  },
  {
  ...
  },
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Not at all', high: 'Significantly' }
    },
    required: true,
  },

  // Section 9: Integration and Adoption
  {
    ...
    type: 'choice',
    options: [
      'Assist initially, later replace',
      'Must integrate into existing system',
      'Only if it fully replaces'
    ],
    required: true,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      'On-site support',
      'Clear consent flow',
      'No medico-legal risk on nurse',
      'Minimal extra steps'
    ],
    conditions: [
      { questionId: 'nurse_pilot_willingness', operator: 'in', value: ['Yes', 'Maybe'] }
    ],
    required: true,
  },
  {
    ...
    conditions: [
      { questionId: 'nurse_consent_followup', operator: 'equals', value: true }
    ],
    required: false,
  },
  {
...
// ============================================
// DOCTOR QUESTIONS (36 questions, 8 sections)
// ============================================

export const doctorQuestions: QuestionData[] = [
  ...
  // Section 1: Orders, Documentation, and Rounds
  {
  ...
  },
  {
    ...
    options: [
      ...
      'Shift change',
      'Documentation gaps',
      'Unclear order format',
      'Device/system issues'
    ],
    required: true,
  },

  // Section 2: Nurse Communication Quality
  {
  ...
  // Section 3: Voice Capture and AI Notes
  {
  ...
  },
  {
    ...
    type: 'multi-choice',
    options: [
      'Nurse verifies before saving',
      'Only structured text stored, no audio',
      'Consent from patient',
      'Department-limited pilot',
      'Audit trail for edits'
    ],
    conditions: [
      { questionId: 'doctor_voice_nurse_notes', operator: 'equals', value: 'Depends' }
    ],
    required: true,
  },
  {
  ...
  },
  {
    ...
    conditions: [
      { questionId: 'doctor_capture_during_rounds', operator: 'notEquals', value: 'No' }
    ],
    required: true,
  },
  {
  ...
  },
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Not at all', high: 'Definitely' }
    },
    required: true,
  },
  {
  ...
  // Section 5: Handover and Continuity
  {
  ...
  },
  {
    ...
    options: [
      ...
      'Recent orders',
      'Family issues',
      'Medication schedule exceptions'
    ],
    required: true,
  },

  // Section 6: Integration, Compliance, Legal
  {
  ...
  },
  {
    ...
    options: [
      ...
      'Doctor',
      'Hospital policy',
      'Shared with explicit verification step'
    ],
    required: true,
  },
  ...
  // Section 7: Feature Prioritization
  {
    ...
    config: {
      min: 1,
      max: 5,
      likertLabels: { low: 'Not useful', high: 'Essential' }
    },
    required: true,
  },
  {
  ...
  },
  {
    ...
    type: 'multi-choice',
    options: [
      'Reduced nurse documentation time',
...
export const allQuestions: QuestionData[] = [...nurseQuestions, ...doctorQuestions];
